        ...
        <section className="min-h-screen w-full flex flex-col gap-y-12 mb-24">
            ...
            <div className="flex justify-center items-center gap-12 flex-col md:flex-row">
                ...
                <div className="home-image w-fit flex justify-center max-w-[300px] max-h-[300px]">
                    <Image src='/images/profile.jpg' width={300} height={300} alt="profile-image" className="rounded-xl" style={{ objectFit: 'cover', objectPosition: '60% 10%'}} />
                </div>
                ...
                <div className="max-w-1/3 work-card bg-[#F7E6F0] px-4 py-4 rounded-md shadow-md shadow-[#9E77BF]/20">
                    ...
                    <div className="bg-white/50 p-2 rounded-lg">
                        <ul className="grid grid-flow-row gap-4">
                            <li className="hover:bg-white/80 p-4 rounded-lg flex justify-between w-full cursor-pointer" onClick={() => isClick('expWork')}>
                                <div className="flex flex-col w-full" id="work-list">
                                    <div className="flex justify-between w-full mb-2">
                                        ...
                                        <div className="w-fit flex flex-col gap-2 py-1">
                                            <span className="w-full text-right text-sm text-gray-500">Jan - Agu 2024</span>
                                        ...
                                        <div className="ml-4">
                                            <ul className="list-disc list-outside">
                                                {expWork.map((data, index) => (
                                                    <li key={index}>
                                                        <small dangerouslySetInnerHTML={{ __html: highlightLMSI(data) }} />
                                                    </li>
                                                ))}
                                            </ul>
                                        </div>
