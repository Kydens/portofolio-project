...
const ProjectsCard = (props) => {
    return (
        <div className="card h-full w-full px-4 py-4 rounded-md shadow-md border-gray-50 border-2 shadow-[#9E77BF]/20 bg-white border-[#4E3A69]/30 hover:bg-[#F7E6F0] transition-all duration-200">
